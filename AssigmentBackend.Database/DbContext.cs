    ...
    public class DbContext
    {
        ...
        public DbContext()
        {
            ...
            this.Bookings = new List<Booking>()
            {
                ...
                new Booking(1, "Meeting B", new DateTime(2024, 01, 01, 10, 15, 00), new DateTime(2024, 01, 01, 10, 30, 00), new List<int>() { 1, 2 }),
                new Booking(1, "Meeting B", new DateTime(2024, 01, 01, 11, 00, 00), new DateTime(2024, 01, 01, 14, 00, 00), new List<int>() { 2 })
            };
        }
    }
}
